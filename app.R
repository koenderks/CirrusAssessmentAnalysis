...
i18n <- list(
  en = list(
    ...
    report_caa_22_plots_intro = "The item difficulty (P-value) and item discrimination (RIT) are shown again in the figures below, with colored areas representing thresholds.",
    report_caa_23_intro = "This heatmap below shows correlations between all assessment items.",
